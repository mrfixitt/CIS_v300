	...
	<body>
		<div data-role="page" data-theme="b">
			...
			<div data-role="content" id="navcontainer">
				<a href="../StudentInterface/selectCourseStudent.php" data-role="button" data-transition="slide" data-theme="a">Select Course</a>
				<a href="../StudentInterface/editAccountFormStudent.php" data-role="button" data-transition="slide" data-theme="a">Edit Account</a>
			<div>
