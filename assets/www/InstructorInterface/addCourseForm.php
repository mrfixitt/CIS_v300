	...
	<div data-role="page" data-theme="b">
		...
		<div data-role="content">
			<form method="post" action="addCourse.php">
				<label for="course" class="ui-hidden-accessible">Course Name:</label>
				<input type="text" id="course" name="course" placeholder="Course Name:" required="required" data-theme="a"/>
				<input type="submit" value="Submit" name="submit" data-icon="check"/>			
			</form>
			<div><br/>
