<html>
	<head>
		...
		<div data-role="page" data-theme="b">
			<div data-role="header" data-theme="a" id="hdCourseSelect">
			...
			<div data-role="content" id="navcontainer">
				...
				<a href="../InstructorInterface/addCourseForm.php" data-role="button" data-transition="slide" data-theme="a">Add Course</a>
				<a href="../InstructorInterface/removeCourseForm.php" data-role="button" data-transition="slide" data-theme="a">Remove Course</a>
				<a href="../InstructorInterface/selectCourseInstructor.php" data-role="button" data-transition="slide" data-theme="a">Select Course</a>
				<a href="../InstructorInterface/editAccountFormInstructor.php" data-role="button" data-transition="slide" data-theme="a">Edit Account</a>
